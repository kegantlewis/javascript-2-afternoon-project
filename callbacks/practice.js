...
function contains(arr, name, callback){
  if (arr.includes(name)) {
    var para = callback(true);
  } else {
    var para = callback(false);
  }
  return para
}
